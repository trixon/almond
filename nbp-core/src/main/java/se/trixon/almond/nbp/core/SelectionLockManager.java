 ...
 */
package se.trixon.almond.nbp.core;
 ...
 */
public class SelectionLockManager {

    public static long DEFAULT_TIMEOUT = TimeUnit.SECONDS.toMillis(5);
    private static final Logger LOGGER = Logger.getLogger(SelectionLockManager.class.getName());
    ...
    public static SelectionLockManager getInstance() {
        return Holder.INSTANCE;
    }

    private SelectionLockManager() {
...
//        });
    ...
    private static class Holder {
        ...
        private static final SelectionLockManager INSTANCE = new SelectionLockManager();
    }
