...
public class ImageViewPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        imagePanel = new se.trixon.almond.nbp.imageviewer.ImagePanel();
        ...
        prevButton.setToolTipText(Dict.PREVIOUS.toString());
        ...
        nextButton.setToolTipText(Dict.NEXT.toString());
    ...
    private se.trixon.almond.nbp.imageviewer.ImagePanel imagePanel;
