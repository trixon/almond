...
final class IconPanel extends javax.swing.JPanel {
    ...
    private transient final ResourceBundle mBundle = SystemHelper.getBundle(LookAndFeelPanel.class, "Bundle");
    private transient final IconOptionsPanelController controller;
