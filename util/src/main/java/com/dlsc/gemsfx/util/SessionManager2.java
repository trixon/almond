...
public class SessionManager2 {
     ...
     */
    public SessionManager2(Preferences preferences) {
    ...
    /**
     * Registers a double property so that any changes made to that property
     * will be
     * persisted in the user's preferences and restored for the next client
     * session.
     *
     * @param path the path to use for the property (e.g. "divider.location").
     * Paths must
    ...
    /**
     * Registers an integer property so that any changes made to that property
     * will be
     * persisted in the user's preferences and restored for the next client
     * session.
     *
    ...
    /**
     * Registers a float property so that any changes made to that property will
     * be
     * persisted in the user's preferences and restored for the next client
     * session.
     *
    ...
    /**
     * Registers a long property so that any changes made to that property will
     * be
     * persisted in the user's preferences and restored for the next client
     * session.
     *
    ...
    /**
     * Registers a boolean property so that any changes made to that property
     * will be
     * persisted in the user's preferences and restored for the next client
     * session.
     *
    ...
    /**
     * Registers a string property so that any changes made to that property
     * will be
     * persisted in the user's preferences and restored for the next client
     * session.
     *
