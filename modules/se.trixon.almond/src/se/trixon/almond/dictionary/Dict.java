...
public enum Dict {
    ...
    CATEGORY, CONTAINS, COPYRIGHT, DATE, DESCRIPTION, DESTINATION, ENDS_WITH, FILE, FILE_EXISTS_MESSAGE, FILE_EXISTS_TITLE, FILE_NOT_FOUND_MESSAGE, FILE_NOT_FOUND_TITLE, INFORMATION, LICENSE, NAME, OPERATION_COMPLETED, PATH, PROJECT, ROWS_NOT_SELECTED_MESSAGE, ROWS_NOT_SELECTED_TITLE, SEARCHING_IN, SIZE, SOURCE, STARTS_WITH, TASK_COMPLETED, TYPE, VERSION;
