...
public enum Dict {
    ...
    CATEGORY, CONTAINS, COPYRIGHT, DATE, DESCRIPTION, DESTINATION, ENDS_WITH, FILE_NOT_FOUND_MESSAGE, FILE_NOT_FOUND_TITLE, INFORMATION, LICENSE, NAME, PATH, PROJECT, SEARCHING_IN, SIZE, SOURCE, STARTS_WITH, TASK_COMPLETED, TYPE, VERSION;
